...
public partial class ICC21ViewModel : ViewModelBase
{
    ...
    public ICC21ViewModel(MainViewModel mainViewModel, HomeViewModel homeViewModel)
    {
    ...
    public void SubmitFlasherMisfires(string text)
    {
        ...
        {
            _homeViewModel.AppendToLog("Error ICC21: FlasherMisfires input is empty.\n");
            return;
        }
        ...
        if (int.TryParse(text, out int misfires))
        {
            if (misfires >= 0) // Adjust validation as needed
            {
                ...
                _homeViewModel.AppendToLog($"ICC21 FlasherMisfires updated to {misfires}.\n");
            ...
            {
                _homeViewModel.AppendToLog("Error ICC21: FlasherMisfires must be non-negative.\n");
                FlasherMisfireBackground = new SolidColorBrush(Colors.Yellow);
            }
        }
        else
        {
            _homeViewModel.AppendToLog("Error ICC21: Invalid FlasherMisfires input. Please enter a number.\n");
            FlasherMisfireBackground = new SolidColorBrush(Colors.Yellow);
        }
    }
    ...
    public void SubmitStartByte(string text)
    {
        if (string.IsNullOrWhiteSpace(text))
        {
            _homeViewModel.AppendToLog("Error ICC21: Start Byte input is empty.\n");
            return;
        }
        ...
        if (isValidInput)
        {
            ...
            _homeViewModel.AppendToLog($"ICC21 Start Byte updated to 0x{startByte.ToString("X2")}.\n");
        ...
        {
            _homeViewModel.AppendToLog("Error ICC21: Invalid Start Byte input. Please enter a byte number without '0x'.\n");
    ...
    public void SubmitDestinationByte(string text)
    {
        if (string.IsNullOrWhiteSpace(text))
        {
            _homeViewModel.AppendToLog("Error ICC21: Destination Byte input is empty.\n");
            return;
        }
        ...
        if (isValidInput)
        {
            ...
            _homeViewModel.AppendToLog($"ICC21 Destination Byte updated to 0x{destinationByte.ToString("X2")}.\n");
        ...
        {
            _homeViewModel.AppendToLog("Error ICC21: Invalid Destination Byte input. Please enter a byte number without '0x'.\n");
    ...
    public void SubmitSourceByte(string text)
    {
        if (string.IsNullOrWhiteSpace(text))
        {
            _homeViewModel.AppendToLog("Error ICC21: Source Byte input is empty.\n");
            return;
        }
        ...
        if (isValidInput)
        {
            ...
            _homeViewModel.AppendToLog($"ICC21 Source Byte updated to 0x{sourceByte.ToString("X2")}.\n");

            // Update cmMessageData or other logic if needed
            _mainViewModel.SendCmCommand(); // Send updated cmMessageData

            if (sourceByte != _mainViewModel.icc21)
            {
        ...
        {
            _homeViewModel.AppendToLog("Error ICC21: Invalid Source Byte input. Please enter a byte number without '0x'.\n");
    ...
    public void SubmitEndByte(string text)
    {
        if (string.IsNullOrWhiteSpace(text))
        {
            _homeViewModel.AppendToLog("Error ICC21: End Byte input is empty.\n");
            return;
        }
        ...
        if (isValidInput)
        {
            ...
            _homeViewModel.AppendToLog($"ICC21 End Byte updated to 0x{endByte.ToString("X2")}.\n");
        ...
        {
            _homeViewModel.AppendToLog("Error ICC21: Invalid End Byte input. Please enter a byte number without '0x'.\n");
    ...
    {
        if (_mainViewModel.icc21On && !_mainViewModel.cmAuto)
        {
            _mainViewModel.icc21On = false;
            _mainViewModel.Icc21SideMenu = "OFF";
            _mainViewModel.Icc21BorderBrush = new SolidColorBrush(Colors.Black);
            _mainViewModel.Icc21BorderBackground = new SolidColorBrush(Colors.Black);
            _homeViewModel.Lvicc21PgBackground = new SolidColorBrush(Colors.LightGray);
            ...
            _mainViewModel.icc21Rem = false;

            _mainViewModel.icc21MessageData = (byte)(_mainViewModel.icc21MessageData ^ _mainViewModel.fOffByte);
            _mainViewModel.icc21MessageData = (byte)(_mainViewModel.icc21MessageData ^ _mainViewModel.fOnByte);

            if (_mainViewModel.icc21Low)
            {
                _mainViewModel.icc21Low = false;
                _mainViewModel.icc21MessageData = (byte)(_mainViewModel.icc21MessageData ^ _mainViewModel.fLowByte);
            }
            if (_mainViewModel.icc21Med)
            {
                _mainViewModel.icc21MessageData = (byte)(_mainViewModel.icc21MessageData ^ _mainViewModel.fMedByte);
                _mainViewModel.icc21Med = false;
            }
            if (_mainViewModel.icc21High)
            {
                _mainViewModel.icc21MessageData = (byte)(_mainViewModel.icc21MessageData ^ _mainViewModel.fHighByte);
                _mainViewModel.icc21High = false;
            }
    ...
    public void OnButtonClicked()
    {
        if (!_mainViewModel.icc21On && !_mainViewModel.cmAuto)
        {
            _mainViewModel.icc21On = true;
            _mainViewModel.Icc21SideMenu = "";
            _mainViewModel.Icc21BorderBrush = new SolidColorBrush(Colors.Green);
            _mainViewModel.Icc21BorderBackground = new SolidColorBrush(Colors.Green);
            _homeViewModel.Lvicc21PgBackground = new SolidColorBrush(Colors.Green);
    ...
    public void RemButtonClicked()
    {
        if (_mainViewModel.icc21On && !_mainViewModel.cmAuto)
        {
            if (!_mainViewModel.icc21Rem)
            {
                _mainViewModel.icc21Rem = true;
    ...
    {
        if (_mainViewModel.icc21On && !_mainViewModel.icc21Low && !_mainViewModel.cmAuto)
        {
            if (_mainViewModel.icc21Med)
            {
                _mainViewModel.icc21MessageData = (byte)(_mainViewModel.icc21MessageData ^ _mainViewModel.fMedByte);
            ...
            _mainViewModel.icc21Low = true;
            _mainViewModel.Icc21SideMenu = "LOW";
            _mainViewModel.Icc21BorderBrush = new SolidColorBrush(Colors.Green);
            _mainViewModel.Icc21BorderBackground = new SolidColorBrush(Colors.Green);
            _homeViewModel.Lvicc21PgBackground = new SolidColorBrush(Colors.Green);
    ...
    {
        if (_mainViewModel.icc21On && !_mainViewModel.icc21Med && !_mainViewModel.cmAuto)
        {
            if (_mainViewModel.icc21Low)
            {
                _mainViewModel.icc21MessageData = (byte)(_mainViewModel.icc21MessageData ^ _mainViewModel.fLowByte);
            ...
            _mainViewModel.icc21Med = true;
            _mainViewModel.Icc21SideMenu = "MED";
            _mainViewModel.Icc21BorderBrush = new SolidColorBrush(Colors.Orange);
            _mainViewModel.Icc21BorderBackground = new SolidColorBrush(Colors.Orange);
            _homeViewModel.Lvicc21PgBackground = new SolidColorBrush(Colors.Orange);
    ...
    {
        if (_mainViewModel.icc21On && !_mainViewModel.icc21High && !_mainViewModel.cmAuto)
        {
            if (_mainViewModel.icc21Low)
            {
                _mainViewModel.icc21MessageData = (byte)(_mainViewModel.icc21MessageData ^ _mainViewModel.fLowByte);
            ...
            _mainViewModel.icc21High = true;
            _mainViewModel.Icc21SideMenu = "HIGH";
            _mainViewModel.Icc21BorderBrush = new SolidColorBrush(Colors.OrangeRed);
            _mainViewModel.Icc21BorderBackground = new SolidColorBrush(Colors.OrangeRed);
            _homeViewModel.Lvicc21PgBackground = new SolidColorBrush(Colors.OrangeRed);
