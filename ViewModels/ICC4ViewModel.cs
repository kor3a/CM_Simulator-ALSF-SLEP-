...
public partial class ICC4ViewModel : ViewModelBase
{
    ...
    public ICC4ViewModel(MainViewModel mainViewModel, HomeViewModel homeViewModel)
    {
    ...
    public void SubmitFlasherMisfires(string text)
    {
        ...
        {
            _homeViewModel.AppendToLog("Error ICC4: FlasherMisfires input is empty.\n");
            return;
        }
        ...
        if (int.TryParse(text, out int misfires))
        {
            if (misfires >= 0) // Adjust validation as needed
            {
                ...
                _homeViewModel.AppendToLog($"ICC4 FlasherMisfires updated to {misfires}.\n");
            ...
            {
                _homeViewModel.AppendToLog("Error ICC4: FlasherMisfires must be non-negative.\n");
                FlasherMisfireBackground = new SolidColorBrush(Colors.Yellow);
            }
        }
        else
        {
            _homeViewModel.AppendToLog("Error ICC4: Invalid FlasherMisfires input. Please enter a number.\n");
            FlasherMisfireBackground = new SolidColorBrush(Colors.Yellow);
        }
    }
    ...
    public void SubmitStartByte(string text)
    {
        if (string.IsNullOrWhiteSpace(text))
        {
            _homeViewModel.AppendToLog("Error ICC4: Start Byte input is empty.\n");
            return;
        }
        ...
        if (isValidInput)
        {
            ...
            _homeViewModel.AppendToLog($"ICC4 Start Byte updated to 0x{startByte.ToString("X2")}.\n");
        ...
        {
            _homeViewModel.AppendToLog("Error ICC4: Invalid Start Byte input. Please enter a byte number without '0x'.\n");
    ...
    public void SubmitDestinationByte(string text)
    {
        if (string.IsNullOrWhiteSpace(text))
        {
            _homeViewModel.AppendToLog("Error ICC4: Destination Byte input is empty.\n");
            return;
        }
        ...
        if (isValidInput)
        {
            ...
            _homeViewModel.AppendToLog($"ICC4 Destination Byte updated to 0x{destinationByte.ToString("X2")}.\n");
        ...
        {
            _homeViewModel.AppendToLog("Error ICC4: Invalid Destination Byte input. Please enter a byte number without '0x'.\n");
    ...
    public void SubmitSourceByte(string text)
    {
        if (string.IsNullOrWhiteSpace(text))
        {
            _homeViewModel.AppendToLog("Error ICC4: Source Byte input is empty.\n");
            return;
        }
        ...
        if (isValidInput)
        {
            ...
            _homeViewModel.AppendToLog($"ICC4 Source Byte updated to 0x{sourceByte.ToString("X2")}.\n");

            // Update cmMessageData or other logic if needed
            _mainViewModel.SendCmCommand(); // Send updated cmMessageData

            if (sourceByte != _mainViewModel.icc4)
            {
        ...
        {
            _homeViewModel.AppendToLog("Error ICC4: Invalid Source Byte input. Please enter a byte number without '0x'.\n");
    ...
    public void SubmitEndByte(string text)
    {
        if (string.IsNullOrWhiteSpace(text))
        {
            _homeViewModel.AppendToLog("Error ICC4: End Byte input is empty.\n");
            return;
        }
        ...
        if (isValidInput)
        {
            ...
            _homeViewModel.AppendToLog($"ICC4 End Byte updated to 0x{endByte.ToString("X2")}.\n");
        ...
        {
            _homeViewModel.AppendToLog("Error ICC4: Invalid End Byte input. Please enter a byte number without '0x'.\n");
    ...
    {
        if (_mainViewModel.icc4On && !_mainViewModel.cmAuto)
        {
            _mainViewModel.icc4On = false;
            _mainViewModel.Icc4SideMenu = "OFF";
            _mainViewModel.Icc4BorderBrush = new SolidColorBrush(Colors.Black);
            _mainViewModel.Icc4BorderBackground = new SolidColorBrush(Colors.Black);
            _homeViewModel.Lvicc4PgBackground = new SolidColorBrush(Colors.LightGray);
            ...
            _mainViewModel.icc4Rem = false;

            _mainViewModel.icc4MessageData = (byte)(_mainViewModel.icc4MessageData ^ _mainViewModel.fOffByte);
            _mainViewModel.icc4MessageData = (byte)(_mainViewModel.icc4MessageData ^ _mainViewModel.fOnByte);

            if (_mainViewModel.icc4Low)
            {
                _mainViewModel.icc4Low = false;
                _mainViewModel.icc4MessageData = (byte)(_mainViewModel.icc4MessageData ^ _mainViewModel.fLowByte);
            }
            if (_mainViewModel.icc4Med)
            {
                _mainViewModel.icc4MessageData = (byte)(_mainViewModel.icc4MessageData ^ _mainViewModel.fMedByte);
                _mainViewModel.icc4Med = false;
            }
            if (_mainViewModel.icc4High)
            {
                _mainViewModel.icc4MessageData = (byte)(_mainViewModel.icc4MessageData ^ _mainViewModel.fHighByte);
                _mainViewModel.icc4High = false;
            }
    ...
    public void OnButtonClicked()
    {
        if (!_mainViewModel.icc4On && !_mainViewModel.cmAuto)
        {
            _mainViewModel.icc4On = true;
            _mainViewModel.Icc4SideMenu = "";
            _mainViewModel.Icc4BorderBrush = new SolidColorBrush(Colors.Green);
            _mainViewModel.Icc4BorderBackground = new SolidColorBrush(Colors.Green);
            _homeViewModel.Lvicc4PgBackground = new SolidColorBrush(Colors.Green);
    ...
    public void RemButtonClicked()
    {
        if (_mainViewModel.icc4On && !_mainViewModel.cmAuto)
        {
            if (!_mainViewModel.icc4Rem)
            {
                _mainViewModel.icc4Rem = true;
    ...
    {
        if (_mainViewModel.icc4On && !_mainViewModel.icc4Low && !_mainViewModel.cmAuto)
        {
            if (_mainViewModel.icc4Med)
            {
                _mainViewModel.icc4MessageData = (byte)(_mainViewModel.icc4MessageData ^ _mainViewModel.fMedByte);
            ...
            _mainViewModel.icc4Low = true;
            _mainViewModel.Icc4SideMenu = "LOW";
            _mainViewModel.Icc4BorderBrush = new SolidColorBrush(Colors.Green);
            _mainViewModel.Icc4BorderBackground = new SolidColorBrush(Colors.Green);
            _homeViewModel.Lvicc4PgBackground = new SolidColorBrush(Colors.Green);
    ...
    {
        if (_mainViewModel.icc4On && !_mainViewModel.icc4Med && !_mainViewModel.cmAuto)
        {
            if (_mainViewModel.icc4Low)
            {
                _mainViewModel.icc4MessageData = (byte)(_mainViewModel.icc4MessageData ^ _mainViewModel.fLowByte);
            ...
            _mainViewModel.icc4Med = true;
            _mainViewModel.Icc4SideMenu = "MED";
            _mainViewModel.Icc4BorderBrush = new SolidColorBrush(Colors.Orange);
            _mainViewModel.Icc4BorderBackground = new SolidColorBrush(Colors.Orange);
            _homeViewModel.Lvicc4PgBackground = new SolidColorBrush(Colors.Orange);
    ...
    {
        if (_mainViewModel.icc4On && !_mainViewModel.icc4High && !_mainViewModel.cmAuto)
        {
            if (_mainViewModel.icc4Low)
            {
                _mainViewModel.icc4MessageData = (byte)(_mainViewModel.icc4MessageData ^ _mainViewModel.fLowByte);
            ...
            _mainViewModel.icc4High = true;
            _mainViewModel.Icc4SideMenu = "HIGH";
            _mainViewModel.Icc4BorderBrush = new SolidColorBrush(Colors.OrangeRed);
            _mainViewModel.Icc4BorderBackground = new SolidColorBrush(Colors.OrangeRed);
            _homeViewModel.Lvicc4PgBackground = new SolidColorBrush(Colors.OrangeRed);
