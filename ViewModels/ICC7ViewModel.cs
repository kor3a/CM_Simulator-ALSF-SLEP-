...
public partial class ICC7ViewModel : ViewModelBase
{
    ...
    public ICC7ViewModel(MainViewModel mainViewModel, HomeViewModel homeViewModel)
    {
    ...
    public void SubmitFlasherMisfires(string text)
    {
        ...
        {
            _homeViewModel.AppendToLog("Error ICC7: FlasherMisfires input is empty.\n");
            return;
        }
        ...
        if (int.TryParse(text, out int misfires))
        {
            if (misfires >= 0) // Adjust validation as needed
            {
                ...
                _homeViewModel.AppendToLog($"ICC7 FlasherMisfires updated to {misfires}.\n");
            ...
            {
                _homeViewModel.AppendToLog("Error ICC7: FlasherMisfires must be non-negative.\n");
                FlasherMisfireBackground = new SolidColorBrush(Colors.Yellow);
            }
        }
        else
        {
            _homeViewModel.AppendToLog("Error ICC7: Invalid FlasherMisfires input. Please enter a number.\n");
            FlasherMisfireBackground = new SolidColorBrush(Colors.Yellow);
        }
    }
    ...
    public void SubmitStartByte(string text)
    {
        if (string.IsNullOrWhiteSpace(text))
        {
            _homeViewModel.AppendToLog("Error ICC7: Start Byte input is empty.\n");
            return;
        }
        ...
        if (isValidInput)
        {
            ...
            _homeViewModel.AppendToLog($"ICC7 Start Byte updated to 0x{startByte.ToString("X2")}.\n");
        ...
        {
            _homeViewModel.AppendToLog("Error ICC7: Invalid Start Byte input. Please enter a byte number without '0x'.\n");
    ...
    public void SubmitDestinationByte(string text)
    {
        if (string.IsNullOrWhiteSpace(text))
        {
            _homeViewModel.AppendToLog("Error ICC7: Destination Byte input is empty.\n");
            return;
        }
        ...
        if (isValidInput)
        {
            ...
            _homeViewModel.AppendToLog($"ICC7 Destination Byte updated to 0x{destinationByte.ToString("X2")}.\n");
        ...
        {
            _homeViewModel.AppendToLog("Error ICC7: Invalid Destination Byte input. Please enter a byte number without '0x'.\n");
    ...
    public void SubmitSourceByte(string text)
    {
        if (string.IsNullOrWhiteSpace(text))
        {
            _homeViewModel.AppendToLog("Error ICC7: Source Byte input is empty.\n");
            return;
        }
        ...
        if (isValidInput)
        {
            ...
            _homeViewModel.AppendToLog($"ICC7 Source Byte updated to 0x{sourceByte.ToString("X2")}.\n");

            // Update cmMessageData or other logic if needed
            _mainViewModel.SendCmCommand(); // Send updated cmMessageData

            if (sourceByte != _mainViewModel.icc7)
            {
        ...
        {
            _homeViewModel.AppendToLog("Error ICC7: Invalid Source Byte input. Please enter a byte number without '0x'.\n");
    ...
    public void SubmitEndByte(string text)
    {
        if (string.IsNullOrWhiteSpace(text))
        {
            _homeViewModel.AppendToLog("Error ICC7: End Byte input is empty.\n");
            return;
        }
        ...
        if (isValidInput)
        {
            ...
            _homeViewModel.AppendToLog($"ICC7 End Byte updated to 0x{endByte.ToString("X2")}.\n");
        ...
        {
            _homeViewModel.AppendToLog("Error ICC7: Invalid End Byte input. Please enter a byte number without '0x'.\n");
    ...
    {
        if (_mainViewModel.icc7On && !_mainViewModel.cmAuto)
        {
            _mainViewModel.icc7On = false;
            _mainViewModel.Icc7SideMenu = "OFF";
            _mainViewModel.Icc7BorderBrush = new SolidColorBrush(Colors.Black);
            _mainViewModel.Icc7BorderBackground = new SolidColorBrush(Colors.Black);
            _homeViewModel.Lvicc7PgBackground = new SolidColorBrush(Colors.LightGray);
            ...
            _mainViewModel.icc7Rem = false;

            _mainViewModel.icc7MessageData = (byte)(_mainViewModel.icc7MessageData ^ _mainViewModel.fOffByte);
            _mainViewModel.icc7MessageData = (byte)(_mainViewModel.icc7MessageData ^ _mainViewModel.fOnByte);

            if (_mainViewModel.icc7Low)
            {
                _mainViewModel.icc7Low = false;
                _mainViewModel.icc7MessageData = (byte)(_mainViewModel.icc7MessageData ^ _mainViewModel.fLowByte);
            }
            if (_mainViewModel.icc7Med)
            {
                _mainViewModel.icc7MessageData = (byte)(_mainViewModel.icc7MessageData ^ _mainViewModel.fMedByte);
                _mainViewModel.icc7Med = false;
            }
            if (_mainViewModel.icc7High)
            {
                _mainViewModel.icc7MessageData = (byte)(_mainViewModel.icc7MessageData ^ _mainViewModel.fHighByte);
                _mainViewModel.icc7High = false;
            }
    ...
    public void OnButtonClicked()
    {
        if (!_mainViewModel.icc7On && !_mainViewModel.cmAuto)
        {
            _mainViewModel.icc7On = true;
            _mainViewModel.Icc7SideMenu = "";
            _mainViewModel.Icc7BorderBrush = new SolidColorBrush(Colors.Green);
            _mainViewModel.Icc7BorderBackground = new SolidColorBrush(Colors.Green);
            _homeViewModel.Lvicc7PgBackground = new SolidColorBrush(Colors.Green);
    ...
    public void RemButtonClicked()
    {
        if (_mainViewModel.icc7On && !_mainViewModel.cmAuto)
        {
            if (!_mainViewModel.icc7Rem)
            {
                _mainViewModel.icc7Rem = true;
    ...
    {
        if (_mainViewModel.icc7On && !_mainViewModel.icc7Low && !_mainViewModel.cmAuto)
        {
            if (_mainViewModel.icc7Med)
            {
                _mainViewModel.icc7MessageData = (byte)(_mainViewModel.icc7MessageData ^ _mainViewModel.fMedByte);
            ...
            _mainViewModel.icc7Low = true;
            _mainViewModel.Icc7SideMenu = "LOW";
            _mainViewModel.Icc7BorderBrush = new SolidColorBrush(Colors.Green);
            _mainViewModel.Icc7BorderBackground = new SolidColorBrush(Colors.Green);
            _homeViewModel.Lvicc7PgBackground = new SolidColorBrush(Colors.Green);
    ...
    {
        if (_mainViewModel.icc7On && !_mainViewModel.icc7Med && !_mainViewModel.cmAuto)
        {
            if (_mainViewModel.icc7Low)
            {
                _mainViewModel.icc7MessageData = (byte)(_mainViewModel.icc7MessageData ^ _mainViewModel.fLowByte);
            ...
            _mainViewModel.icc7Med = true;
            _mainViewModel.Icc7SideMenu = "MED";
            _mainViewModel.Icc7BorderBrush = new SolidColorBrush(Colors.Orange);
            _mainViewModel.Icc7BorderBackground = new SolidColorBrush(Colors.Orange);
            _homeViewModel.Lvicc7PgBackground = new SolidColorBrush(Colors.Orange);
    ...
    {
        if (_mainViewModel.icc7On && !_mainViewModel.icc7High && !_mainViewModel.cmAuto)
        {
            if (_mainViewModel.icc7Low)
            {
                _mainViewModel.icc7MessageData = (byte)(_mainViewModel.icc7MessageData ^ _mainViewModel.fLowByte);
            ...
            _mainViewModel.icc7High = true;
            _mainViewModel.Icc7SideMenu = "HIGH";
            _mainViewModel.Icc7BorderBrush = new SolidColorBrush(Colors.OrangeRed);
            _mainViewModel.Icc7BorderBackground = new SolidColorBrush(Colors.OrangeRed);
            _homeViewModel.Lvicc7PgBackground = new SolidColorBrush(Colors.OrangeRed);
