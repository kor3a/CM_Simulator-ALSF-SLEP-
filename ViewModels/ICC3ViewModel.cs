...
public partial class ICC3ViewModel : ViewModelBase, ILviccPage
{
    ...
    public ICC3ViewModel(MainViewModel mainViewModel, HomeViewModel homeViewModel)
    {
    ...
    public void SubmitFlasherMisfires(string text)
    {
        ...
        {
            _homeViewModel.AppendLog("Error ICC3: FlasherMisfires input is empty.");
            return;
        }
        ...
        if (int.TryParse(text, out int misfires))
        {
            if (misfires >= 0) // Adjust validation as needed
            {
                ...
                //_homeViewModel.AppendLog($"ICC3 FlasherMisfires updated to {misfires}.");
            ...
            {
                _homeViewModel.AppendLog("Error ICC3: FlasherMisfires must be non-negative.");
                FlasherMisfireBackground = new SolidColorBrush(Colors.Yellow);
            }
        }
        else
        {
            _homeViewModel.AppendLog("Error ICC3: Invalid FlasherMisfires input. Please enter a number.");
            FlasherMisfireBackground = new SolidColorBrush(Colors.Yellow);
        }
    }
    ...
    public void SubmitStartByte(string text)
    {
        if (string.IsNullOrWhiteSpace(text))
        {
            _homeViewModel.AppendLog("Error ICC3: Start Byte input is empty.");
            return;
        }
        ...
        if (isValidInput)
        {
            ...
            _homeViewModel.AppendLog($"ICC3 Start Byte updated to 0x{startByte.ToString("X2")}.");
        ...
        {
            _homeViewModel.AppendLog("Error ICC3: Invalid Start Byte input. Please enter a byte number without '0x'.");
    ...
    public void SubmitDestinationByte(string text)
    {
        if (string.IsNullOrWhiteSpace(text))
        {
            _homeViewModel.AppendLog("Error ICC3: Destination Byte input is empty.");
            return;
        }
        ...
        if (isValidInput)
        {
            ...
            _homeViewModel.AppendLog($"ICC3 Destination Byte updated to 0x{destinationByte.ToString("X2")}.");
        ...
        {
            _homeViewModel.AppendLog("Error ICC3: Invalid Destination Byte input. Please enter a byte number without '0x'.");
    ...
    public void SubmitSourceByte(string text)
    {
        if (string.IsNullOrWhiteSpace(text))
        {
            _homeViewModel.AppendLog("Error ICC3: Source Byte input is empty.");
            return;
        }
        ...
        if (isValidInput)
        {
            ...
            _homeViewModel.AppendLog($"ICC3 Source Byte updated to 0x{sourceByte.ToString("X2")}.");

            // Update cmMessageData or other logic if needed
            _mainViewModel.SendCmCommand(); // Send updated cmMessageData

            if (sourceByte != _mainViewModel.icc3)
            {
        ...
        {
            _homeViewModel.AppendLog("Error ICC3: Invalid Source Byte input. Please enter a byte number without '0x'.");
    ...
    public void SubmitEndByte(string text)
    {
        if (string.IsNullOrWhiteSpace(text))
        {
            _homeViewModel.AppendLog("Error ICC3: End Byte input is empty.");
            return;
        }
        ...
        if (isValidInput)
        {
            ...
            _homeViewModel.AppendLog($"ICC3 End Byte updated to 0x{endByte.ToString("X2")}.");
        ...
        {
            _homeViewModel.AppendLog("Error ICC3: Invalid End Byte input. Please enter a byte number without '0x'.");
    ...
    {
        if (_mainViewModel.icc3On && !_mainViewModel.cmAuto)
        {
            _mainViewModel.icc3On = false;
            _mainViewModel.Icc3SideMenu = "OFF";
            _mainViewModel.Icc3BorderBrush = new SolidColorBrush(Colors.Black);
            _mainViewModel.Icc3BorderBackground = new SolidColorBrush(Colors.Black);
            _homeViewModel.Lvicc3PgBackground = new SolidColorBrush(Colors.LightGray);
            ...
            _mainViewModel.icc3Rem = false;

            _mainViewModel.icc3MessageData = (byte)(_mainViewModel.icc3MessageData ^ _mainViewModel.fOffByte);
            _mainViewModel.icc3MessageData = (byte)(_mainViewModel.icc3MessageData ^ _mainViewModel.fOnByte);

            if (_mainViewModel.icc3Low)
            {
                _mainViewModel.icc3Low = false;
                _mainViewModel.icc3MessageData = (byte)(_mainViewModel.icc3MessageData ^ _mainViewModel.fLowByte);
            }
            if (_mainViewModel.icc3Med)
            {
                _mainViewModel.icc3MessageData = (byte)(_mainViewModel.icc3MessageData ^ _mainViewModel.fMedByte);
                _mainViewModel.icc3Med = false;
            }
            if (_mainViewModel.icc3High)
            {
                _mainViewModel.icc3MessageData = (byte)(_mainViewModel.icc3MessageData ^ _mainViewModel.fHighByte);
                _mainViewModel.icc3High = false;
            }
    ...
    public void OnButtonClicked()
    {
        if (!_mainViewModel.icc3On && !_mainViewModel.cmAuto)
        {
            _mainViewModel.icc3On = true;
            _mainViewModel.Icc3SideMenu = "";
            _mainViewModel.Icc3BorderBrush = new SolidColorBrush(Colors.Green);
            _mainViewModel.Icc3BorderBackground = new SolidColorBrush(Colors.Green);
            _homeViewModel.Lvicc3PgBackground = new SolidColorBrush(Colors.Green);
    ...
    public void RemButtonClicked()
    {
        if (_mainViewModel.icc3On && !_mainViewModel.cmAuto)
        {
            if (!_mainViewModel.icc3Rem)
            {
                _mainViewModel.icc3Rem = true;
    ...
    {
        if (_mainViewModel.icc3On && !_mainViewModel.icc3Low && !_mainViewModel.cmAuto)
        {
            if (_mainViewModel.icc3Med)
            {
                _mainViewModel.icc3MessageData = (byte)(_mainViewModel.icc3MessageData ^ _mainViewModel.fMedByte);
            ...
            _mainViewModel.icc3Low = true;
            _mainViewModel.Icc3SideMenu = "LOW";
            _mainViewModel.Icc3BorderBrush = new SolidColorBrush(Colors.Green);
            _mainViewModel.Icc3BorderBackground = new SolidColorBrush(Colors.Green);
            _homeViewModel.Lvicc3PgBackground = new SolidColorBrush(Colors.Green);
    ...
    {
        if (_mainViewModel.icc3On && !_mainViewModel.icc3Med && !_mainViewModel.cmAuto)
        {
            if (_mainViewModel.icc3Low)
            {
                _mainViewModel.icc3MessageData = (byte)(_mainViewModel.icc3MessageData ^ _mainViewModel.fLowByte);
            ...
            _mainViewModel.icc3Med = true;
            _mainViewModel.Icc3SideMenu = "MED";
            _mainViewModel.Icc3BorderBrush = new SolidColorBrush(Colors.Orange);
            _mainViewModel.Icc3BorderBackground = new SolidColorBrush(Colors.Orange);
            _homeViewModel.Lvicc3PgBackground = new SolidColorBrush(Colors.Orange);
    ...
    {
        if (_mainViewModel.icc3On && !_mainViewModel.icc3High && !_mainViewModel.cmAuto)
        {
            if (_mainViewModel.icc3Low)
            {
                _mainViewModel.icc3MessageData = (byte)(_mainViewModel.icc3MessageData ^ _mainViewModel.fLowByte);
            ...
            _mainViewModel.icc3High = true;
            _mainViewModel.Icc3SideMenu = "HIGH";
            _mainViewModel.Icc3BorderBrush = new SolidColorBrush(Colors.OrangeRed);
            _mainViewModel.Icc3BorderBackground = new SolidColorBrush(Colors.OrangeRed);
            _homeViewModel.Lvicc3PgBackground = new SolidColorBrush(Colors.OrangeRed);
