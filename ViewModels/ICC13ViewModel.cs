...
public partial class ICC13ViewModel : ViewModelBase
{
    ...
    public ICC13ViewModel(MainViewModel mainViewModel, HomeViewModel homeViewModel)
    {
    ...
    public void SubmitFlasherMisfires(string text)
    {
        ...
        {
            _homeViewModel.AppendToLog("Error ICC13: FlasherMisfires input is empty.\n");
            return;
        }
        ...
        if (int.TryParse(text, out int misfires))
        {
            if (misfires >= 0) // Adjust validation as needed
            {
                ...
                _homeViewModel.AppendToLog($"ICC13 FlasherMisfires updated to {misfires}.\n");
            ...
            {
                _homeViewModel.AppendToLog("Error ICC13: FlasherMisfires must be non-negative.\n");
                FlasherMisfireBackground = new SolidColorBrush(Colors.Yellow);
            }
        }
        else
        {
            _homeViewModel.AppendToLog("Error ICC13: Invalid FlasherMisfires input. Please enter a number.\n");
            FlasherMisfireBackground = new SolidColorBrush(Colors.Yellow);
        }
    }
    ...
    public void SubmitStartByte(string text)
    {
        if (string.IsNullOrWhiteSpace(text))
        {
            _homeViewModel.AppendToLog("Error ICC13: Start Byte input is empty.\n");
            return;
        }
        ...
        if (isValidInput)
        {
            ...
            _homeViewModel.AppendToLog($"ICC13 Start Byte updated to 0x{startByte.ToString("X2")}.\n");
        ...
        {
            _homeViewModel.AppendToLog("Error ICC13: Invalid Start Byte input. Please enter a byte number without '0x'.\n");
    ...
    public void SubmitDestinationByte(string text)
    {
        if (string.IsNullOrWhiteSpace(text))
        {
            _homeViewModel.AppendToLog("Error ICC13: Destination Byte input is empty.\n");
            return;
        }
        ...
        if (isValidInput)
        {
            ...
            _homeViewModel.AppendToLog($"ICC13 Destination Byte updated to 0x{destinationByte.ToString("X2")}.\n");
        ...
        {
            _homeViewModel.AppendToLog("Error ICC13: Invalid Destination Byte input. Please enter a byte number without '0x'.\n");
    ...
    public void SubmitSourceByte(string text)
    {
        if (string.IsNullOrWhiteSpace(text))
        {
            _homeViewModel.AppendToLog("Error ICC13: Source Byte input is empty.\n");
            return;
        }
        ...
        if (isValidInput)
        {
            ...
            _homeViewModel.AppendToLog($"ICC13 Source Byte updated to 0x{sourceByte.ToString("X2")}.\n");

            // Update cmMessageData or other logic if needed
            _mainViewModel.SendCmCommand(); // Send updated cmMessageData

            if (sourceByte != _mainViewModel.icc13)
            {
        ...
        {
            _homeViewModel.AppendToLog("Error ICC13: Invalid Source Byte input. Please enter a byte number without '0x'.\n");
    ...
    public void SubmitEndByte(string text)
    {
        if (string.IsNullOrWhiteSpace(text))
        {
            _homeViewModel.AppendToLog("Error ICC13: End Byte input is empty.\n");
            return;
        }
        ...
        if (isValidInput)
        {
            ...
            _homeViewModel.AppendToLog($"ICC13 End Byte updated to 0x{endByte.ToString("X2")}.\n");
        ...
        {
            _homeViewModel.AppendToLog("Error ICC13: Invalid End Byte input. Please enter a byte number without '0x'.\n");
    ...
    {
        if (_mainViewModel.icc13On && !_mainViewModel.cmAuto)
        {
            _mainViewModel.icc13On = false;
            _mainViewModel.Icc13SideMenu = "OFF";
            _mainViewModel.Icc13BorderBrush = new SolidColorBrush(Colors.Black);
            _mainViewModel.Icc13BorderBackground = new SolidColorBrush(Colors.Black);
            _homeViewModel.Lvicc13PgBackground = new SolidColorBrush(Colors.LightGray);
            ...
            _mainViewModel.icc13Rem = false;

            _mainViewModel.icc13MessageData = (byte)(_mainViewModel.icc13MessageData ^ _mainViewModel.fOffByte);
            _mainViewModel.icc13MessageData = (byte)(_mainViewModel.icc13MessageData ^ _mainViewModel.fOnByte);

            if (_mainViewModel.icc13Low)
            {
                _mainViewModel.icc13Low = false;
                _mainViewModel.icc13MessageData = (byte)(_mainViewModel.icc13MessageData ^ _mainViewModel.fLowByte);
            }
            if (_mainViewModel.icc13Med)
            {
                _mainViewModel.icc13MessageData = (byte)(_mainViewModel.icc13MessageData ^ _mainViewModel.fMedByte);
                _mainViewModel.icc13Med = false;
            }
            if (_mainViewModel.icc13High)
            {
                _mainViewModel.icc13MessageData = (byte)(_mainViewModel.icc13MessageData ^ _mainViewModel.fHighByte);
                _mainViewModel.icc13High = false;
            }
    ...
    public void OnButtonClicked()
    {
        if (!_mainViewModel.icc13On && !_mainViewModel.cmAuto)
        {
            _mainViewModel.icc13On = true;
            _mainViewModel.Icc13SideMenu = "";
            _mainViewModel.Icc13BorderBrush = new SolidColorBrush(Colors.Green);
            _mainViewModel.Icc13BorderBackground = new SolidColorBrush(Colors.Green);
            _homeViewModel.Lvicc13PgBackground = new SolidColorBrush(Colors.Green);
    ...
    public void RemButtonClicked()
    {
        if (_mainViewModel.icc13On && !_mainViewModel.cmAuto)
        {
            if (!_mainViewModel.icc13Rem)
            {
                _mainViewModel.icc13Rem = true;
    ...
    {
        if (_mainViewModel.icc13On && !_mainViewModel.icc13Low && !_mainViewModel.cmAuto)
        {
            if (_mainViewModel.icc13Med)
            {
                _mainViewModel.icc13MessageData = (byte)(_mainViewModel.icc13MessageData ^ _mainViewModel.fMedByte);
            ...
            _mainViewModel.icc13Low = true;
            _mainViewModel.Icc13SideMenu = "LOW";
            _mainViewModel.Icc13BorderBrush = new SolidColorBrush(Colors.Green);
            _mainViewModel.Icc13BorderBackground = new SolidColorBrush(Colors.Green);
            _homeViewModel.Lvicc13PgBackground = new SolidColorBrush(Colors.Green);
    ...
    {
        if (_mainViewModel.icc13On && !_mainViewModel.icc13Med && !_mainViewModel.cmAuto)
        {
            if (_mainViewModel.icc13Low)
            {
                _mainViewModel.icc13MessageData = (byte)(_mainViewModel.icc13MessageData ^ _mainViewModel.fLowByte);
            ...
            _mainViewModel.icc13Med = true;
            _mainViewModel.Icc13SideMenu = "MED";
            _mainViewModel.Icc13BorderBrush = new SolidColorBrush(Colors.Orange);
            _mainViewModel.Icc13BorderBackground = new SolidColorBrush(Colors.Orange);
            _homeViewModel.Lvicc13PgBackground = new SolidColorBrush(Colors.Orange);
    ...
    {
        if (_mainViewModel.icc13On && !_mainViewModel.icc13High && !_mainViewModel.cmAuto)
        {
            if (_mainViewModel.icc13Low)
            {
                _mainViewModel.icc13MessageData = (byte)(_mainViewModel.icc13MessageData ^ _mainViewModel.fLowByte);
            ...
            _mainViewModel.icc13High = true;
            _mainViewModel.Icc13SideMenu = "HIGH";
            _mainViewModel.Icc13BorderBrush = new SolidColorBrush(Colors.OrangeRed);
            _mainViewModel.Icc13BorderBackground = new SolidColorBrush(Colors.OrangeRed);
            _homeViewModel.Lvicc13PgBackground = new SolidColorBrush(Colors.OrangeRed);
