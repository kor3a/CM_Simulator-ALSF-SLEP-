...
public partial class ICC8ViewModel : ViewModelBase
{
    ...
    public ICC8ViewModel(MainViewModel mainViewModel, HomeViewModel homeViewModel)
    {
    ...
    public void SubmitFlasherMisfires(string text)
    {
        ...
        {
            _homeViewModel.AppendToLog("Error ICC8: FlasherMisfires input is empty.\n");
            return;
        }
        ...
        if (int.TryParse(text, out int misfires))
        {
            if (misfires >= 0) // Adjust validation as needed
            {
                ...
                _homeViewModel.AppendToLog($"ICC8 FlasherMisfires updated to {misfires}.\n");
            ...
            {
                _homeViewModel.AppendToLog("Error ICC8: FlasherMisfires must be non-negative.\n");
                FlasherMisfireBackground = new SolidColorBrush(Colors.Yellow);
            }
        }
        else
        {
            _homeViewModel.AppendToLog("Error ICC8: Invalid FlasherMisfires input. Please enter a number.\n");
            FlasherMisfireBackground = new SolidColorBrush(Colors.Yellow);
        }
    }
    ...
    public void SubmitStartByte(string text)
    {
        if (string.IsNullOrWhiteSpace(text))
        {
            _homeViewModel.AppendToLog("Error ICC8: Start Byte input is empty.\n");
            return;
        }
        ...
        if (isValidInput)
        {
            ...
            _homeViewModel.AppendToLog($"ICC8 Start Byte updated to 0x{startByte.ToString("X2")}.\n");
        ...
        {
            _homeViewModel.AppendToLog("Error ICC8: Invalid Start Byte input. Please enter a byte number without '0x'.\n");
    ...
    public void SubmitDestinationByte(string text)
    {
        if (string.IsNullOrWhiteSpace(text))
        {
            _homeViewModel.AppendToLog("Error ICC8: Destination Byte input is empty.\n");
            return;
        }
        ...
        if (isValidInput)
        {
            ...
            _homeViewModel.AppendToLog($"ICC8 Destination Byte updated to 0x{destinationByte.ToString("X2")}.\n");
        ...
        {
            _homeViewModel.AppendToLog("Error ICC8: Invalid Destination Byte input. Please enter a byte number without '0x'.\n");
    ...
    public void SubmitSourceByte(string text)
    {
        if (string.IsNullOrWhiteSpace(text))
        {
            _homeViewModel.AppendToLog("Error ICC8: Source Byte input is empty.\n");
            return;
        }
        ...
        if (isValidInput)
        {
            ...
            _homeViewModel.AppendToLog($"ICC8 Source Byte updated to 0x{sourceByte.ToString("X2")}.\n");

            // Update cmMessageData or other logic if needed
            _mainViewModel.SendCmCommand(); // Send updated cmMessageData

            if (sourceByte != _mainViewModel.icc8)
            {
        ...
        {
            _homeViewModel.AppendToLog("Error ICC8: Invalid Source Byte input. Please enter a byte number without '0x'.\n");
    ...
    public void SubmitEndByte(string text)
    {
        if (string.IsNullOrWhiteSpace(text))
        {
            _homeViewModel.AppendToLog("Error ICC8: End Byte input is empty.\n");
            return;
        }
        ...
        if (isValidInput)
        {
            ...
            _homeViewModel.AppendToLog($"ICC8 End Byte updated to 0x{endByte.ToString("X2")}.\n");
        ...
        {
            _homeViewModel.AppendToLog("Error ICC8: Invalid End Byte input. Please enter a byte number without '0x'.\n");
    ...
    {
        if (_mainViewModel.icc8On && !_mainViewModel.cmAuto)
        {
            _mainViewModel.icc8On = false;
            _mainViewModel.Icc8SideMenu = "OFF";
            _mainViewModel.Icc8BorderBrush = new SolidColorBrush(Colors.Black);
            _mainViewModel.Icc8BorderBackground = new SolidColorBrush(Colors.Black);
            _homeViewModel.Lvicc8PgBackground = new SolidColorBrush(Colors.LightGray);
            ...
            _mainViewModel.icc8Rem = false;

            _mainViewModel.icc8MessageData = (byte)(_mainViewModel.icc8MessageData ^ _mainViewModel.fOffByte);
            _mainViewModel.icc8MessageData = (byte)(_mainViewModel.icc8MessageData ^ _mainViewModel.fOnByte);

            if (_mainViewModel.icc8Low)
            {
                _mainViewModel.icc8Low = false;
                _mainViewModel.icc8MessageData = (byte)(_mainViewModel.icc8MessageData ^ _mainViewModel.fLowByte);
            }
            if (_mainViewModel.icc8Med)
            {
                _mainViewModel.icc8MessageData = (byte)(_mainViewModel.icc8MessageData ^ _mainViewModel.fMedByte);
                _mainViewModel.icc8Med = false;
            }
            if (_mainViewModel.icc8High)
            {
                _mainViewModel.icc8MessageData = (byte)(_mainViewModel.icc8MessageData ^ _mainViewModel.fHighByte);
                _mainViewModel.icc8High = false;
            }
    ...
    public void OnButtonClicked()
    {
        if (!_mainViewModel.icc8On && !_mainViewModel.cmAuto)
        {
            _mainViewModel.icc8On = true;
            _mainViewModel.Icc8SideMenu = "";
            _mainViewModel.Icc8BorderBrush = new SolidColorBrush(Colors.Green);
            _mainViewModel.Icc8BorderBackground = new SolidColorBrush(Colors.Green);
            _homeViewModel.Lvicc8PgBackground = new SolidColorBrush(Colors.Green);
    ...
    public void RemButtonClicked()
    {
        if (_mainViewModel.icc8On && !_mainViewModel.cmAuto)
        {
            if (!_mainViewModel.icc8Rem)
            {
                _mainViewModel.icc8Rem = true;
    ...
    {
        if (_mainViewModel.icc8On && !_mainViewModel.icc8Low && !_mainViewModel.cmAuto)
        {
            if (_mainViewModel.icc8Med)
            {
                _mainViewModel.icc8MessageData = (byte)(_mainViewModel.icc8MessageData ^ _mainViewModel.fMedByte);
            ...
            _mainViewModel.icc8Low = true;
            _mainViewModel.Icc8SideMenu = "LOW";
            _mainViewModel.Icc8BorderBrush = new SolidColorBrush(Colors.Green);
            _mainViewModel.Icc8BorderBackground = new SolidColorBrush(Colors.Green);
            _homeViewModel.Lvicc8PgBackground = new SolidColorBrush(Colors.Green);
    ...
    {
        if (_mainViewModel.icc8On && !_mainViewModel.icc8Med && !_mainViewModel.cmAuto)
        {
            if (_mainViewModel.icc8Low)
            {
                _mainViewModel.icc8MessageData = (byte)(_mainViewModel.icc8MessageData ^ _mainViewModel.fLowByte);
            ...
            _mainViewModel.icc8Med = true;
            _mainViewModel.Icc8SideMenu = "MED";
            _mainViewModel.Icc8BorderBrush = new SolidColorBrush(Colors.Orange);
            _mainViewModel.Icc8BorderBackground = new SolidColorBrush(Colors.Orange);
            _homeViewModel.Lvicc8PgBackground = new SolidColorBrush(Colors.Orange);
    ...
    {
        if (_mainViewModel.icc8On && !_mainViewModel.icc8High && !_mainViewModel.cmAuto)
        {
            if (_mainViewModel.icc8Low)
            {
                _mainViewModel.icc8MessageData = (byte)(_mainViewModel.icc8MessageData ^ _mainViewModel.fLowByte);
            ...
            _mainViewModel.icc8High = true;
            _mainViewModel.Icc8SideMenu = "HIGH";
            _mainViewModel.Icc8BorderBrush = new SolidColorBrush(Colors.OrangeRed);
            _mainViewModel.Icc8BorderBackground = new SolidColorBrush(Colors.OrangeRed);
            _homeViewModel.Lvicc8PgBackground = new SolidColorBrush(Colors.OrangeRed);
