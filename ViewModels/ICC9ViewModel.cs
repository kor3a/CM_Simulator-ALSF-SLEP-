...
public partial class ICC9ViewModel : ViewModelBase
{
    ...
    public ICC9ViewModel(MainViewModel mainViewModel, HomeViewModel homeViewModel)
    {
    ...
    public void SubmitFlasherMisfires(string text)
    {
        ...
        {
            _homeViewModel.AppendToLog("Error ICC9: FlasherMisfires input is empty.\n");
            return;
        }
        ...
        if (int.TryParse(text, out int misfires))
        {
            if (misfires >= 0) // Adjust validation as needed
            {
                ...
                _homeViewModel.AppendToLog($"ICC9 FlasherMisfires updated to {misfires}.\n");
            ...
            {
                _homeViewModel.AppendToLog("Error ICC9: FlasherMisfires must be non-negative.\n");
                FlasherMisfireBackground = new SolidColorBrush(Colors.Yellow);
            }
        }
        else
        {
            _homeViewModel.AppendToLog("Error ICC9: Invalid FlasherMisfires input. Please enter a number.\n");
            FlasherMisfireBackground = new SolidColorBrush(Colors.Yellow);
        }
    }
    ...
    public void SubmitStartByte(string text)
    {
        if (string.IsNullOrWhiteSpace(text))
        {
            _homeViewModel.AppendToLog("Error ICC9: Start Byte input is empty.\n");
            return;
        }
        ...
        if (isValidInput)
        {
            ...
            _homeViewModel.AppendToLog($"ICC9 Start Byte updated to 0x{startByte.ToString("X2")}.\n");
        ...
        {
            _homeViewModel.AppendToLog("Error ICC9: Invalid Start Byte input. Please enter a byte number without '0x'.\n");
    ...
    public void SubmitDestinationByte(string text)
    {
        if (string.IsNullOrWhiteSpace(text))
        {
            _homeViewModel.AppendToLog("Error ICC9: Destination Byte input is empty.\n");
            return;
        }
        ...
        if (isValidInput)
        {
            ...
            _homeViewModel.AppendToLog($"ICC9 Destination Byte updated to 0x{destinationByte.ToString("X2")}.\n");
        ...
        {
            _homeViewModel.AppendToLog("Error ICC9: Invalid Destination Byte input. Please enter a byte number without '0x'.\n");
    ...
    public void SubmitSourceByte(string text)
    {
        if (string.IsNullOrWhiteSpace(text))
        {
            _homeViewModel.AppendToLog("Error ICC9: Source Byte input is empty.\n");
            return;
        }
        ...
        if (isValidInput)
        {
            ...
            _homeViewModel.AppendToLog($"ICC9 Source Byte updated to 0x{sourceByte.ToString("X2")}.\n");

            // Update cmMessageData or other logic if needed
            _mainViewModel.SendCmCommand(); // Send updated cmMessageData

            if (sourceByte != _mainViewModel.icc9)
            {
        ...
        {
            _homeViewModel.AppendToLog("Error ICC9: Invalid Source Byte input. Please enter a byte number without '0x'.\n");
    ...
    public void SubmitEndByte(string text)
    {
        if (string.IsNullOrWhiteSpace(text))
        {
            _homeViewModel.AppendToLog("Error ICC9: End Byte input is empty.\n");
            return;
        }
        ...
        if (isValidInput)
        {
            ...
            _homeViewModel.AppendToLog($"ICC9 End Byte updated to 0x{endByte.ToString("X2")}.\n");
        ...
        {
            _homeViewModel.AppendToLog("Error ICC9: Invalid End Byte input. Please enter a byte number without '0x'.\n");
    ...
    {
        if (_mainViewModel.icc9On && !_mainViewModel.cmAuto)
        {
            _mainViewModel.icc9On = false;
            _mainViewModel.Icc9SideMenu = "OFF";
            _mainViewModel.Icc9BorderBrush = new SolidColorBrush(Colors.Black);
            _mainViewModel.Icc9BorderBackground = new SolidColorBrush(Colors.Black);
            _homeViewModel.Lvicc9PgBackground = new SolidColorBrush(Colors.LightGray);
            ...
            _mainViewModel.icc9Rem = false;

            _mainViewModel.icc9MessageData = (byte)(_mainViewModel.icc9MessageData ^ _mainViewModel.fOffByte);
            _mainViewModel.icc9MessageData = (byte)(_mainViewModel.icc9MessageData ^ _mainViewModel.fOnByte);

            if (_mainViewModel.icc9Low)
            {
                _mainViewModel.icc9Low = false;
                _mainViewModel.icc9MessageData = (byte)(_mainViewModel.icc9MessageData ^ _mainViewModel.fLowByte);
            }
            if (_mainViewModel.icc9Med)
            {
                _mainViewModel.icc9MessageData = (byte)(_mainViewModel.icc9MessageData ^ _mainViewModel.fMedByte);
                _mainViewModel.icc9Med = false;
            }
            if (_mainViewModel.icc9High)
            {
                _mainViewModel.icc9MessageData = (byte)(_mainViewModel.icc9MessageData ^ _mainViewModel.fHighByte);
                _mainViewModel.icc9High = false;
            }
    ...
    public void OnButtonClicked()
    {
        if (!_mainViewModel.icc9On && !_mainViewModel.cmAuto)
        {
            _mainViewModel.icc9On = true;
            _mainViewModel.Icc9SideMenu = "";
            _mainViewModel.Icc9BorderBrush = new SolidColorBrush(Colors.Green);
            _mainViewModel.Icc9BorderBackground = new SolidColorBrush(Colors.Green);
            _homeViewModel.Lvicc9PgBackground = new SolidColorBrush(Colors.Green);
    ...
    public void RemButtonClicked()
    {
        if (_mainViewModel.icc9On && !_mainViewModel.cmAuto)
        {
            if (!_mainViewModel.icc9Rem)
            {
                _mainViewModel.icc9Rem = true;
    ...
    {
        if (_mainViewModel.icc9On && !_mainViewModel.icc9Low && !_mainViewModel.cmAuto)
        {
            if (_mainViewModel.icc9Med)
            {
                _mainViewModel.icc9MessageData = (byte)(_mainViewModel.icc9MessageData ^ _mainViewModel.fMedByte);
            ...
            _mainViewModel.icc9Low = true;
            _mainViewModel.Icc9SideMenu = "LOW";
            _mainViewModel.Icc9BorderBrush = new SolidColorBrush(Colors.Green);
            _mainViewModel.Icc9BorderBackground = new SolidColorBrush(Colors.Green);
            _homeViewModel.Lvicc9PgBackground = new SolidColorBrush(Colors.Green);
    ...
    {
        if (_mainViewModel.icc9On && !_mainViewModel.icc9Med && !_mainViewModel.cmAuto)
        {
            if (_mainViewModel.icc9Low)
            {
                _mainViewModel.icc9MessageData = (byte)(_mainViewModel.icc9MessageData ^ _mainViewModel.fLowByte);
            ...
            _mainViewModel.icc9Med = true;
            _mainViewModel.Icc9SideMenu = "MED";
            _mainViewModel.Icc9BorderBrush = new SolidColorBrush(Colors.Orange);
            _mainViewModel.Icc9BorderBackground = new SolidColorBrush(Colors.Orange);
            _homeViewModel.Lvicc9PgBackground = new SolidColorBrush(Colors.Orange);
    ...
    {
        if (_mainViewModel.icc9On && !_mainViewModel.icc9High && !_mainViewModel.cmAuto)
        {
            if (_mainViewModel.icc9Low)
            {
                _mainViewModel.icc9MessageData = (byte)(_mainViewModel.icc9MessageData ^ _mainViewModel.fLowByte);
            ...
            _mainViewModel.icc9High = true;
            _mainViewModel.Icc9SideMenu = "HIGH";
            _mainViewModel.Icc9BorderBrush = new SolidColorBrush(Colors.OrangeRed);
            _mainViewModel.Icc9BorderBackground = new SolidColorBrush(Colors.OrangeRed);
            _homeViewModel.Lvicc9PgBackground = new SolidColorBrush(Colors.OrangeRed);
