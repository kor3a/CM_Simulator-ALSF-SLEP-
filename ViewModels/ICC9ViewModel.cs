...
public partial class ICC9ViewModel : ViewModelBase, ILviccPage
{
    ...
    public void SubmitFlasherMisfires(string text)
    {
        ...
        {
            _homeViewModel.AppendLog("Error ICC9: FlasherMisfires input is empty.");
            return;
        }
        ...
        if (int.TryParse(text, out int misfires))
        {
            if (misfires >= 0) // Adjust validation as needed
            {
                ...
                _homeViewModel.AppendLog($"ICC9 FlasherMisfires updated to {misfires}.");
            ...
            {
                _homeViewModel.AppendLog("Error ICC9: FlasherMisfires must be non-negative.");
                FlasherMisfireBackground = new SolidColorBrush(Colors.Yellow);
            }
        }
        else
        {
            _homeViewModel.AppendLog("Error ICC9: Invalid FlasherMisfires input. Please enter a number.");
            FlasherMisfireBackground = new SolidColorBrush(Colors.Yellow);
        }
    }
    ...
    public void SubmitStartByte(string text)
    {
        if (string.IsNullOrWhiteSpace(text))
        {
            _homeViewModel.AppendLog("Error ICC9: Start Byte input is empty.");
            return;
        }
        ...
        if (isValidInput)
        {
            ...
            _homeViewModel.AppendLog($"ICC9 Start Byte updated to 0x{startByte.ToString("X2")}.");
        ...
        {
            _homeViewModel.AppendLog("Error ICC9: Invalid Start Byte input. Please enter a byte number without '0x'.");
    ...
    public void SubmitDestinationByte(string text)
    {
        if (string.IsNullOrWhiteSpace(text))
        {
            _homeViewModel.AppendLog("Error ICC9: Destination Byte input is empty.");
            return;
        }
        ...
        if (isValidInput)
        {
            ...
            _homeViewModel.AppendLog($"ICC9 Destination Byte updated to 0x{destinationByte.ToString("X2")}.");
        ...
        {
            _homeViewModel.AppendLog("Error ICC9: Invalid Destination Byte input. Please enter a byte number without '0x'.");
    ...
    public void SubmitSourceByte(string text)
    {
        if (string.IsNullOrWhiteSpace(text))
        {
            _homeViewModel.AppendLog("Error ICC9: Source Byte input is empty.");
            return;
        }
        ...
        if (isValidInput)
        {
            ...
            _homeViewModel.AppendLog($"ICC9 Source Byte updated to 0x{sourceByte.ToString("X2")}.");
        ...
        {
            _homeViewModel.AppendLog("Error ICC9: Invalid Source Byte input. Please enter a byte number without '0x'.");
    ...
    public void SubmitEndByte(string text)
    {
        if (string.IsNullOrWhiteSpace(text))
        {
            _homeViewModel.AppendLog("Error ICC9: End Byte input is empty.");
            return;
        }
        ...
        if (isValidInput)
        {
            ...
            _homeViewModel.AppendLog($"ICC9 End Byte updated to 0x{endByte.ToString("X2")}.");
        ...
        {
            _homeViewModel.AppendLog("Error ICC9: Invalid End Byte input. Please enter a byte number without '0x'.");
