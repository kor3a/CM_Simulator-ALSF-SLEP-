...
public partial class ICC1ViewModel : ViewModelBase
{
    ...
    public ICC1ViewModel(MainViewModel mainViewModel, HomeViewModel homeViewModel)
    {
    ...
    public void SubmitFlasherMisfires(string text)
    {
        ...
        {
            _homeViewModel.AppendToLog("Error ICC1: FlasherMisfires input is empty.\n");
            return;
        }
        ...
        if (int.TryParse(text, out int misfires))
        {
            if (misfires >= 0) // Adjust validation as needed
            {
                ...
                _homeViewModel.AppendToLog($"ICC1 FlasherMisfires updated to {misfires}.\n");
            ...
            {
                _homeViewModel.AppendToLog("Error ICC1: FlasherMisfires must be non-negative.\n");
                FlasherMisfireBackground = new SolidColorBrush(Colors.Yellow);
            }
        }
        else
        {
            _homeViewModel.AppendToLog("Error ICC1: Invalid FlasherMisfires input. Please enter a number.\n");
            FlasherMisfireBackground = new SolidColorBrush(Colors.Yellow);
        }
    }
    ...
    public void SubmitStartByte(string text)
    {
        if (string.IsNullOrWhiteSpace(text))
        {
            _homeViewModel.AppendToLog("Error ICC1: Start Byte input is empty.\n");
            return;
        }
        ...
        if (isValidInput)
        {
            ...
            _homeViewModel.AppendToLog($"ICC1 Start Byte updated to 0x{startByte.ToString("X2")}.\n");
        ...
        {
            _homeViewModel.AppendToLog("Error ICC1: Invalid Start Byte input. Please enter a byte number without '0x'.\n");
    ...
    public void SubmitDestinationByte(string text)
    {
        if (string.IsNullOrWhiteSpace(text))
        {
            _homeViewModel.AppendToLog("Error ICC1: Destination Byte input is empty.\n");
            return;
        }
        ...
        if (isValidInput)
        {
            ...
            _homeViewModel.AppendToLog($"ICC1 Destination Byte updated to 0x{destinationByte.ToString("X2")}.\n");
        ...
        {
            _homeViewModel.AppendToLog("Error ICC1: Invalid Destination Byte input. Please enter a byte number without '0x'.\n");
    ...
    public void SubmitSourceByte(string text)
    {
        if (string.IsNullOrWhiteSpace(text))
        {
            _homeViewModel.AppendToLog("Error ICC1: Source Byte input is empty.\n");
            return;
        }
        ...
        if (isValidInput)
        {
            ...
            _homeViewModel.AppendToLog($"ICC1 Source Byte updated to 0x{sourceByte.ToString("X2")}.\n");

            // Update cmMessageData or other logic if needed
            _mainViewModel.SendCmCommand(); // Send updated cmMessageData

            if (sourceByte != _mainViewModel.icc1)
            {
        ...
        {
            _homeViewModel.AppendToLog("Error ICC1: Invalid Source Byte input. Please enter a byte number without '0x'.\n");
    ...
    public void SubmitEndByte(string text)
    {
        if (string.IsNullOrWhiteSpace(text))
        {
            _homeViewModel.AppendToLog("Error ICC1: End Byte input is empty.\n");
            return;
        }
        ...
        if (isValidInput)
        {
            ...
            _homeViewModel.AppendToLog($"ICC1 End Byte updated to 0x{endByte.ToString("X2")}.\n");
        ...
        {
            _homeViewModel.AppendToLog("Error ICC1: Invalid End Byte input. Please enter a byte number without '0x'.\n");
    ...
    {
        if (_mainViewModel.icc1On)
        {
            _mainViewModel.icc1On = false;
            _mainViewModel.Icc1SideMenu = "OFF";
            _mainViewModel.Icc1BorderBrush = new SolidColorBrush(Colors.Black);
            _mainViewModel.Icc1BorderBackground = new SolidColorBrush(Colors.Black);
            _mainViewModel.Icc1SideBackground = new SolidColorBrush(Colors.LightGray);
            _homeViewModel.Lvicc1PgBackground = new SolidColorBrush(Colors.LightGray);
            ...
            _mainViewModel.icc1Rem = false;

            _mainViewModel.icc1MessageData = (byte)(_mainViewModel.icc1MessageData ^ _mainViewModel.fOffByte);
            _mainViewModel.icc1MessageData = (byte)(_mainViewModel.icc1MessageData ^ _mainViewModel.fOnByte);

            if (_mainViewModel.icc1Low)
            {
                _mainViewModel.icc1Low = false;
                _mainViewModel.icc1MessageData = (byte)(_mainViewModel.icc1MessageData ^ _mainViewModel.fLowByte);
            }
            if (_mainViewModel.icc1Med)
            {
                _mainViewModel.icc1MessageData = (byte)(_mainViewModel.icc1MessageData ^ _mainViewModel.fMedByte);
                _mainViewModel.icc1Med = false;
            }
            if (_mainViewModel.icc1High)
            {
                _mainViewModel.icc1MessageData = (byte)(_mainViewModel.icc1MessageData ^ _mainViewModel.fHighByte);
                _mainViewModel.icc1High = false;
            }
    ...
    public void OnButtonClicked()
    {
        if (!_mainViewModel.icc1On)
        {
            _mainViewModel.icc1On = true;
            _mainViewModel.Icc1SideMenu = "";
            _mainViewModel.Icc1BorderBrush = new SolidColorBrush(Colors.Green);
            _mainViewModel.Icc1BorderBackground = new SolidColorBrush(Colors.Green);
            _mainViewModel.Icc1SideBackground = new SolidColorBrush(Colors.Green);
            _homeViewModel.Lvicc1PgBackground = new SolidColorBrush(Colors.Green);
    ...
    public void RemButtonClicked()
    {
        if (_mainViewModel.icc1On)
        {
            if (!_mainViewModel.icc1Rem)
            {
                _mainViewModel.icc1Rem = true;
    ...
    {
        if(_mainViewModel.icc1On && !_mainViewModel.icc1Low)
        {
            if (_mainViewModel.icc1Med)
            {
                _mainViewModel.icc1MessageData = (byte)(_mainViewModel.icc1MessageData ^ _mainViewModel.fMedByte);
            ...
            _mainViewModel.icc1Low = true;
            _mainViewModel.Icc1SideMenu = "LOW";
            _mainViewModel.Icc1BorderBrush = new SolidColorBrush(Colors.Green);
            _mainViewModel.Icc1BorderBackground = new SolidColorBrush(Colors.Green);
            _mainViewModel.Icc1SideBackground = new SolidColorBrush(Colors.Green);
            _homeViewModel.Lvicc1PgBackground = new SolidColorBrush(Colors.Green);
    ...
    {
        if (_mainViewModel.icc1On && !_mainViewModel.icc1Med && !_mainViewModel.cmAuto)
        {
            if (_mainViewModel.icc1Low)
            {
                _mainViewModel.icc1MessageData = (byte)(_mainViewModel.icc1MessageData ^ _mainViewModel.fLowByte);
            ...
            _mainViewModel.icc1Med = true;
            _mainViewModel.Icc1SideMenu = "MED";
            _mainViewModel.Icc1BorderBrush = new SolidColorBrush(Colors.Orange);
            _mainViewModel.Icc1BorderBackground = new SolidColorBrush(Colors.Orange);
            _mainViewModel.Icc1SideBackground = new SolidColorBrush(Colors.Orange);
            _homeViewModel.Lvicc1PgBackground = new SolidColorBrush(Colors.Orange);
    ...
    {
        if (_mainViewModel.icc1On && !_mainViewModel.icc1High && !_mainViewModel.cmAuto)
        {
            if (_mainViewModel.icc1Low)
            {
                _mainViewModel.icc1MessageData = (byte)(_mainViewModel.icc1MessageData ^ _mainViewModel.fLowByte);
            ...
            _mainViewModel.icc1High = true;
            _mainViewModel.Icc1SideMenu = "HIGH";
            _mainViewModel.Icc1BorderBrush = new SolidColorBrush(Colors.OrangeRed);
            _mainViewModel.Icc1BorderBackground = new SolidColorBrush(Colors.OrangeRed);
            _mainViewModel.Icc1SideBackground = new SolidColorBrush(Colors.OrangeRed);
            _homeViewModel.Lvicc1PgBackground = new SolidColorBrush(Colors.OrangeRed);
