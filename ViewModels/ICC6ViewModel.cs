...
public partial class ICC6ViewModel : ViewModelBase
{
    ...
    public ICC6ViewModel(MainViewModel mainViewModel, HomeViewModel homeViewModel)
    {
    ...
    public void SubmitFlasherMisfires(string text)
    {
        ...
        {
            _homeViewModel.AppendToLog("Error ICC6: FlasherMisfires input is empty.\n");
            return;
        }
        ...
        if (int.TryParse(text, out int misfires))
        {
            if (misfires >= 0) // Adjust validation as needed
            {
                ...
                _homeViewModel.AppendToLog($"ICC6 FlasherMisfires updated to {misfires}.\n");
            ...
            {
                _homeViewModel.AppendToLog("Error ICC6: FlasherMisfires must be non-negative.\n");
                FlasherMisfireBackground = new SolidColorBrush(Colors.Yellow);
            }
        }
        else
        {
            _homeViewModel.AppendToLog("Error ICC6: Invalid FlasherMisfires input. Please enter a number.\n");
            FlasherMisfireBackground = new SolidColorBrush(Colors.Yellow);
        }
    }
    ...
    public void SubmitStartByte(string text)
    {
        if (string.IsNullOrWhiteSpace(text))
        {
            _homeViewModel.AppendToLog("Error ICC6: Start Byte input is empty.\n");
            return;
        }
        ...
        if (isValidInput)
        {
            ...
            _homeViewModel.AppendToLog($"ICC6 Start Byte updated to 0x{startByte.ToString("X2")}.\n");
        ...
        {
            _homeViewModel.AppendToLog("Error ICC6: Invalid Start Byte input. Please enter a byte number without '0x'.\n");
    ...
    public void SubmitDestinationByte(string text)
    {
        if (string.IsNullOrWhiteSpace(text))
        {
            _homeViewModel.AppendToLog("Error ICC6: Destination Byte input is empty.\n");
            return;
        }
        ...
        if (isValidInput)
        {
            ...
            _homeViewModel.AppendToLog($"ICC6 Destination Byte updated to 0x{destinationByte.ToString("X2")}.\n");
        ...
        {
            _homeViewModel.AppendToLog("Error ICC6: Invalid Destination Byte input. Please enter a byte number without '0x'.\n");
    ...
    public void SubmitSourceByte(string text)
    {
        if (string.IsNullOrWhiteSpace(text))
        {
            _homeViewModel.AppendToLog("Error ICC6: Source Byte input is empty.\n");
            return;
        }
        ...
        if (isValidInput)
        {
            ...
            _homeViewModel.AppendToLog($"ICC6 Source Byte updated to 0x{sourceByte.ToString("X2")}.\n");

            // Update cmMessageData or other logic if needed
            _mainViewModel.SendCmCommand(); // Send updated cmMessageData

            if (sourceByte != _mainViewModel.icc6)
            {
        ...
        {
            _homeViewModel.AppendToLog("Error ICC6: Invalid Source Byte input. Please enter a byte number without '0x'.\n");
    ...
    public void SubmitEndByte(string text)
    {
        if (string.IsNullOrWhiteSpace(text))
        {
            _homeViewModel.AppendToLog("Error ICC6: End Byte input is empty.\n");
            return;
        }
        ...
        if (isValidInput)
        {
            ...
            _homeViewModel.AppendToLog($"ICC6 End Byte updated to 0x{endByte.ToString("X2")}.\n");
        ...
        {
            _homeViewModel.AppendToLog("Error ICC6: Invalid End Byte input. Please enter a byte number without '0x'.\n");
    ...
    {
        if (_mainViewModel.icc6On && !_mainViewModel.cmAuto)
        {
            _mainViewModel.icc6On = false;
            _mainViewModel.Icc6SideMenu = "OFF";
            _mainViewModel.Icc6BorderBrush = new SolidColorBrush(Colors.Black);
            _mainViewModel.Icc6BorderBackground = new SolidColorBrush(Colors.Black);
            _homeViewModel.Lvicc6PgBackground = new SolidColorBrush(Colors.LightGray);
            ...
            _mainViewModel.icc6Rem = false;

            _mainViewModel.icc6MessageData = (byte)(_mainViewModel.icc6MessageData ^ _mainViewModel.fOffByte);
            _mainViewModel.icc6MessageData = (byte)(_mainViewModel.icc6MessageData ^ _mainViewModel.fOnByte);

            if (_mainViewModel.icc6Low)
            {
                _mainViewModel.icc6Low = false;
                _mainViewModel.icc6MessageData = (byte)(_mainViewModel.icc6MessageData ^ _mainViewModel.fLowByte);
            }
            if (_mainViewModel.icc6Med)
            {
                _mainViewModel.icc6MessageData = (byte)(_mainViewModel.icc6MessageData ^ _mainViewModel.fMedByte);
                _mainViewModel.icc6Med = false;
            }
            if (_mainViewModel.icc6High)
            {
                _mainViewModel.icc6MessageData = (byte)(_mainViewModel.icc6MessageData ^ _mainViewModel.fHighByte);
                _mainViewModel.icc6High = false;
            }
    ...
    public void OnButtonClicked()
    {
        if (!_mainViewModel.icc6On && !_mainViewModel.cmAuto)
        {
            _mainViewModel.icc6On = true;
            _mainViewModel.Icc6SideMenu = "";
            _mainViewModel.Icc6BorderBrush = new SolidColorBrush(Colors.Green);
            _mainViewModel.Icc6BorderBackground = new SolidColorBrush(Colors.Green);
            _homeViewModel.Lvicc6PgBackground = new SolidColorBrush(Colors.Green);
    ...
    public void RemButtonClicked()
    {
        if (_mainViewModel.icc6On && !_mainViewModel.cmAuto)
        {
            if (!_mainViewModel.icc6Rem)
            {
                _mainViewModel.icc6Rem = true;
    ...
    {
        if (_mainViewModel.icc6On && !_mainViewModel.icc6Low && !_mainViewModel.cmAuto)
        {
            if (_mainViewModel.icc6Med)
            {
                _mainViewModel.icc6MessageData = (byte)(_mainViewModel.icc6MessageData ^ _mainViewModel.fMedByte);
            ...
            _mainViewModel.icc6Low = true;
            _mainViewModel.Icc6SideMenu = "LOW";
            _mainViewModel.Icc6BorderBrush = new SolidColorBrush(Colors.Green);
            _mainViewModel.Icc6BorderBackground = new SolidColorBrush(Colors.Green);
            _homeViewModel.Lvicc6PgBackground = new SolidColorBrush(Colors.Green);
    ...
    {
        if (_mainViewModel.icc6On && !_mainViewModel.icc6Med && !_mainViewModel.cmAuto)
        {
            if (_mainViewModel.icc6Low)
            {
                _mainViewModel.icc6MessageData = (byte)(_mainViewModel.icc6MessageData ^ _mainViewModel.fLowByte);
            ...
            _mainViewModel.icc6Med = true;
            _mainViewModel.Icc6SideMenu = "MED";
            _mainViewModel.Icc6BorderBrush = new SolidColorBrush(Colors.Orange);
            _mainViewModel.Icc6BorderBackground = new SolidColorBrush(Colors.Orange);
            _homeViewModel.Lvicc6PgBackground = new SolidColorBrush(Colors.Orange);
    ...
    {
        if (_mainViewModel.icc6On && !_mainViewModel.icc6High && !_mainViewModel.cmAuto)
        {
            if (_mainViewModel.icc6Low)
            {
                _mainViewModel.icc6MessageData = (byte)(_mainViewModel.icc6MessageData ^ _mainViewModel.fLowByte);
            ...
            _mainViewModel.icc6High = true;
            _mainViewModel.Icc6SideMenu = "HIGH";
            _mainViewModel.Icc6BorderBrush = new SolidColorBrush(Colors.OrangeRed);
            _mainViewModel.Icc6BorderBackground = new SolidColorBrush(Colors.OrangeRed);
            _homeViewModel.Lvicc6PgBackground = new SolidColorBrush(Colors.OrangeRed);
