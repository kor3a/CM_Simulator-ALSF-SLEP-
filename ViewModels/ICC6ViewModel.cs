...
public partial class ICC6ViewModel : ViewModelBase
{
    ...
    public void SubmitFlasherMisfires(string text)
    {
        ...
        {
            _homeViewModel.LogText += "Error ICC6: FlasherMisfires input is empty.\n";
            return;
        }
        ...
        if (int.TryParse(text, out int misfires))
        {
            if (misfires >= 0) // Adjust validation as needed
            {
                ...
                _homeViewModel.LogText += $"ICC6 FlasherMisfires updated to {misfires}.\n";
            ...
            {
                _homeViewModel.LogText += "Error ICC6: FlasherMisfires must be non-negative.\n";
                FlasherMisfireBackground = new SolidColorBrush(Colors.Yellow);
            }
        }
        else
        {
            _homeViewModel.LogText += "Error ICC6: Invalid FlasherMisfires input. Please enter a number.\n";
            FlasherMisfireBackground = new SolidColorBrush(Colors.Yellow);
        }
    }
    ...
    public void SubmitStartByte(string text)
    {
        if (string.IsNullOrWhiteSpace(text))
        {
            _homeViewModel.LogText += "Error ICC6: Start Byte input is empty.\n";
            return;
        }
        ...
        if (isValidInput)
        {
            ...
            _homeViewModel.LogText += $"ICC6 Start Byte updated to 0x{startByte.ToString("X2")}.\n";
        ...
        {
            _homeViewModel.LogText += "Error ICC6: Invalid Start Byte input. Please enter a byte number without '0x'.\n";
    ...
    public void SubmitDestinationByte(string text)
    {
        if (string.IsNullOrWhiteSpace(text))
        {
            _homeViewModel.LogText += "Error ICC6: Destination Byte input is empty.\n";
            return;
        }
        ...
        if (isValidInput)
        {
            ...
            _homeViewModel.LogText += $"ICC6 Destination Byte updated to 0x{destinationByte.ToString("X2")}.\n";
        ...
        {
            _homeViewModel.LogText += "Error ICC6: Invalid Destination Byte input. Please enter a byte number without '0x'.\n";
    ...
    public void SubmitSourceByte(string text)
    {
        if (string.IsNullOrWhiteSpace(text))
        {
            _homeViewModel.LogText += "Error ICC6: Source Byte input is empty.\n";
            return;
        }
        ...
        if (isValidInput)
        {
            ...
            _homeViewModel.LogText += $"ICC6 Source Byte updated to 0x{sourceByte.ToString("X2")}.\n";
        ...
        {
            _homeViewModel.LogText += "Error ICC6: Invalid Source Byte input. Please enter a byte number without '0x'.\n";
    ...
    public void SubmitEndByte(string text)
    {
        if (string.IsNullOrWhiteSpace(text))
        {
            _homeViewModel.LogText += "Error ICC6: End Byte input is empty.\n";
            return;
        }
        ...
        if (isValidInput)
        {
            ...
            _homeViewModel.LogText += $"ICC6 End Byte updated to 0x{endByte.ToString("X2")}.\n";
        ...
        {
            _homeViewModel.LogText += "Error ICC6: Invalid End Byte input. Please enter a byte number without '0x'.\n";
